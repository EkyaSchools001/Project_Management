...
import { AdminOKRData, CampusOKRMetric } from '@pdi/services/okrService';
...
const CampusRow: React.FC<{ c: CampusOKRMetric; index: number }> = ({ c, index }) => (
                ...
                <div className="overflow-x-auto">
                    <Table>
                        ...
                        <TableBody>
                            ...
                            ) : filtered.map((c, index) => <CampusRow key={c.campus} c={c} index={index} />)}
                        </TableBody>
                    </Table>
                </div>
            </Card>
