    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-foreground/40">Manage client invoices</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-[#1a1d24] rounded-2xl p-6 border border-white/5">
          <p className="text-sm text-foreground/40 mb-1">Total Invoiced</p>
        ...
        <div className="bg-[#1a1d24] rounded-2xl p-6 border border-white/5">
          ...
          <p className="text-2xl font-black text-red-500">${paidAmount.toLocaleString()}</p>
        </div>
        <div className="bg-[#1a1d24] rounded-2xl p-6 border border-white/5">
