                                ...
                                {(meeting as any).mom ? (
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid gap-6 sm:grid-cols-2">
                                            <div className="bg-slate-50 rounded-xl p-5 border border-primary/20 shadow-sm">
                                            ...
                                            <div className="bg-slate-50 rounded-xl p-5 border border-primary/20 shadow-sm">
                                                ...
                                                <ul className="space-y-3">
                                                    {(meeting as any).mom.actionItems.map((item: any, i: number) => (
                                                        <li key={i} className="bg-white p-3 rounded-lg border border-primary/20 shadow-sm">
                                    ...
                                    <div className="flex flex-col items-center justify-center py-12 text-center">
                                        <div className="w-16 h-16 rounded-full bg-slate-50 flex items-center justify-center border border-primary/20 mb-4 shadow-sm">
                            ...
                            {((meeting as any).attachments && (meeting as any).attachments.length > 0) ? (
                                <div className="space-y-3">
                                    {(meeting as any).attachments.map((file: any, i: number) => (
                                        <div key={i} className="flex items-center justify-between p-3 rounded-xl border border-primary/20 group hover:border-primary/30 transition-all bg-slate-50/30">
                                            <div className="flex items-center gap-3 min-w-0">
