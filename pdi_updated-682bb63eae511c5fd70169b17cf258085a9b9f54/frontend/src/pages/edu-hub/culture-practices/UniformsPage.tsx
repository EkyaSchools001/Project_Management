...
const UniformsPage = () => {
  ...
  const [data, setData] = useState({
    ...
    mainTitle: "School",
    italicTitle: "Uniforms",
    heroDesc: "Clear guidelines for wearing, monitoring, and maintaining the school uniform at CMR/Ekya.",
    introText: "School uniforms contribute significantly to the school's ethos and set an appropriate professional tone. At Ekya Schools and CMR NPS, uniforms are categorised into Regular, Sports, and Formal wear, varying by grade block. Wearing the correct, complete uniform every day is mandatory, and teachers and the leadership team share responsibility for monitoring compliance.",
    differentiation: "Early Years students wear dark grey T-shirts and purple plaid shorts on all days. Primary students wear the standard white shirt and plaid shorts/skirt. Middle and Senior students have an additional Formal Uniform. Students celebrating birthdays may wear casual dress : modest and presentable. Lab coats are required for Grades 9–12 Science Practicals.",
    quickTip: "Create a laminated 'Uniform Quick Check' card listing all items for each block : post it at your classroom door so you can run a visual check as students enter, keeping compliance consistent without breaking the flow.",
    processSteps: [
      { text: "Students wear the Regular Uniform on all school days unless specified otherwise." },
      { text: "Sports Uniform is worn on days when the student has a PE period, on Sports Day, and on field trips." },
      { text: "Formal Uniform (Grades 8–12 only) is worn on designated weekly days, major events, class photos, and inter-school competitions." },
      { text: "PE and Class teachers check uniform compliance after assembly before students return to class." },
      { text: "Non-compliant students are sent to the CCA Coordinator with their diary for a written parent note." },
      { text: "For a second offence, another diary note is written : parents must acknowledge both." },
      { text: "Written exemptions from parents may be accepted temporarily by the CCA Coordinator." },
      { text: "Third or repeated violations: house point deduction (minus 10 points); extreme cases may result in exclusion from one activity." }
    ],
    dos: [
      { text: "Check uniform daily after assembly : it sets the tone for discipline" },
      { text: "Give a written diary note on the first violation : maintain a paper trail" },
      { text: "Allow written parental exemptions for genuine reasons (temporarily)" },
      { text: "Ensure the school ID is worn at all times" },
      { text: "Remind students of sports uniform days in advance" }
    ],
    donts: [
      { text: "Don't let uniform violations slide : consistency is essential" },
      { text: "Don't shame students publicly : handle it quietly with the Coordinator" },
      { text: "Don't forget to deduct house points after three written violations" },
      { text: "Don't allow casual clothes on non-birthday or non-designated days" },
      { text: "Don't accept verbal explanations for non-compliance : a parent note is required" }
    ],
    glossary: [
      { term: "Regular Uniform", mean: "The standard day-to-day school uniform worn on all days except PE, Formal, or special dress days." },
      { term: "Sports Uniform", mean: "House T-shirt with shorts/track pants, worn on PE days, Sports Day, athletic events, and field trips." },
      { term: "Formal Uniform", mean: "A blazer, full-sleeved shirt, and tie uniform worn by Grades 8–12 on designated formal days and events." },
      { term: "Hall Pass", mean: "A labelled card students carry when leaving the classroom during class hours (washroom or errands)." },
      { term: "CCA Coordinator", mean: "Co-Curricular Activities Coordinator : oversees uniform compliance escalation and house point deductions." }
    ],
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const result = await settingsService.getSetting("page_culture_uniforms");
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] pb-24 rounded-b-[2.5rem] smooth-scroll">
      <PageEditorControls 
        settingKey="page_culture_uniforms"
        initialData={data}
        onSave={setData}
        title="Uniforms Content"
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-24">
        ...
        <section className="space-y-12">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-sm font-black text-primary tracking-[0.3em] uppercase">{data.processSubtitle || "Compliance Steps"}</h2>
        ...
        <section className="space-y-12">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-sm font-black text-primary tracking-[0.3em] uppercase">{data.differentiationSubtitle || "Tailored Guidelines"}</h2>
        ...
        <section className="animate-in fade-in zoom-in duration-700">
          <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-[2.5rem] p-10 md:p-16 border border-amber-200/50 flex flex-col md:flex-row items-center gap-10 shadow-sm relative overflow-hidden">
            ...
            <div className="w-20 h-20 rounded-3xl bg-white shadow-xl flex items-center justify-center flex-none">
              <ShieldCheck className="w-10 h-10 text-amber-500" weight="fill" />
            </div>
