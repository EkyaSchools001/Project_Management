...
export type Role = "teacher" | "leader" | "school_leader" | "admin" | "superadmin" | "management" | "coordinator";
...
const roleConfig = {
  ...
  school_leader: { label: "School Leader", icon: Users, className: "role-leader" },
  ...
  coordinator: { label: "Coordinator", icon: GraduationCap, className: "bg-indigo-600/10 text-indigo-600 border-indigo-600/20" },
};
