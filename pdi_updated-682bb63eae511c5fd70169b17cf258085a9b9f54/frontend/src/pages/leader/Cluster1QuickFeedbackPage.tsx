...
// ── Cluster 1 Rubric Definition ────────────────────────────────────────────────
const SUBDOMAINS = [
  {
    code: "1a", title: "Content Knowledge & Pedagogy",
    params: [
      { id: "1a_1", name: "Content Knowledge", desc: "Teacher demonstrates accurate and deep subject knowledge.", lookFor: "Uses correct terminology, explains concepts clearly, handles misconceptions." },
      { id: "1a_2", name: "Relevant Usage of Tools", desc: "Instructional tools are purposefully integrated.", lookFor: "Tools match the learning objective; students interact with tools meaningfully." },
      { id: "1a_3", name: "Purposeful Questioning", desc: "Questions drive higher-order thinking.", lookFor: "Bloom's levels 3–6, wait time observed, students prompted to elaborate." },
    ],
  },
  {
    code: "1b", title: "Differentiated Planning",
    params: [
      { id: "1b_1", name: "Differentiated Plan", desc: "Lesson accounts for diverse learner needs.", lookFor: "Varied tasks, scaffolds, or extensions visible in plan and delivery." },
    ],
  },
  {
    code: "1c", title: "Learning Outcomes & Alignment",
    params: [
      { id: "1c_1", name: "Well-Defined Learning Outcomes", desc: "Clear, measurable objectives communicated to students.", lookFor: "Objectives posted/stated; students can articulate what they are learning." },
      { id: "1c_2", name: "Alignment of Tasks", desc: "Activities directly address the learning outcome.", lookFor: "Tasks, assessments, and outcomes are coherent and connected." },
    ],
  },
  {
    code: "1d", title: "Use of Resources",
    params: [
      { id: "1d_1", name: "Purposeful Use of Resources", desc: "Resources enhance learning rather than decorate.", lookFor: "Materials chosen with intentionality; students use resources actively." },
    ],
  },
  {
    code: "1e", title: "Lesson Design",
    params: [
      { id: "1e_1", name: "Clear Lesson Flow", desc: "Lesson has logical sequence from hook to closure.", lookFor: "Opening, instruction, practice, and closure are identifiable." },
      { id: "1e_2", name: "Instructions & Task Design", desc: "Tasks are clearly explained and appropriately challenging.", lookFor: "Students understand what to do; tasks have appropriate cognitive demand." },
    ],
  },
];

const TOOLS = [
  "Cold Call","Entry Ticket","Exit Ticket","Think-Pair-Share","Turn & Talk",
  "Do Now","Wait Time","Concept Map","Brainstorming","Hand Signals",
  "Quick Draw / Quick Write","Show Call","Round Table Discussion","T-Chart",
  "Parking Lot","KWL",
];

const ROUTINES = [
  "Arrival Routine","Attendance Routine","Grouping Routine","Lining Up Strategies",
  "Class Cleaning Routine","Material Collection Routine","Departure Routine",
];
...
// ── Main Page ──────────────────────────────────────────────────────────────────
const Cluster1QuickFeedbackPage: React.FC = () => {
  ...
  const buildPayload = (status: "DRAFT" | "SUBMITTED") => ({
    ...
    observerId: user?.id,
    date,
    domain: "Cluster 1 - Planning & Preparation",
    type: "quick-feedback",
    status,
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 pt-6">
          <div className="relative h-[200px] md:h-[240px] overflow-hidden rounded-[2.5rem] shadow-2xl mb-8 bg-[#EA104A]">
            ...
            <div className="absolute inset-0 flex flex-col justify-center pl-10 md:pl-16">
              ...
              <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter leading-[0.9] uppercase drop-shadow-2xl">Planning &amp; Preparation</h1>
              <p className="text-white/80 font-medium text-sm mt-2">Cluster 1 · Quick Feedback</p>
            </div>
          </div>
        </div>
...
export default Cluster1QuickFeedbackPage;
