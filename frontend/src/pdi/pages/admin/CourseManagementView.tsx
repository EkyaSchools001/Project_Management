...
import {
    Search, Plus, BookOpen, Clock, Users, MoreHorizontal, Filter, Edit, Trash2, Eye, FileText, User, Share2, Calendar, ShieldCheck, Download, ChevronRight, X
} from "lucide-react";
...
export function CourseManagementView({ hideHeader = false }: { hideHeader?: boolean }) {
    ...
    const ActionButtons = (user?.role !== 'SCHOOL_LEADER' && user?.role !== 'LEADER') ? (
        <div className="flex gap-2">

            <Button variant="outline" className="gap-2 rounded-xl" onClick={() => setIsDownloadableOpen(true)}>
            ...
            <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>Create a new Teacher Development course.</DialogDescription>
                    </DialogHeader>
        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            {!hideHeader && (
                <PageHeader
                    ...
                    subtitle="Manage Teacher Development courses and workshops"
            ...
            <div className="flex flex-col gap-4 mb-6">
                <div className="flex items-center gap-4">
                    ...
                    <Button
                        ...
                        className={cn(
                            ...
                            (categoryFilter !== "All" || statusFilter !== "All") && "bg-primary/5 border-primary text-primary"
                        )}
                    ...
                    {(categoryFilter !== "All" || statusFilter !== "All" || searchQuery) && (
                        <Button
                            variant="ghost"
                            className="text-muted-foreground text-xs hover:text-primary h-9"
                            onClick={() => {
                ...
                {showFilters && (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-4 rounded-xl bg-muted/20 border border-muted/20 animate-in slide-in-from-top-2 duration-200">
                        <div className="space-y-1.5">
                            ...
                            <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="Culture">Culture</SelectItem>
                                    <SelectItem value="Compliance">Compliance</SelectItem>
                                    <SelectItem value="Downloadable Course">Downloadable</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                                    ...
                                    <TableCell>
                                        <Badge
                                            className={cn(
                                                ...
                                                course.status?.toUpperCase() === 'ACTIVE' ? "bg-emerald-600" :
            ...
            <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>Modify Teacher Development course details.</DialogDescription>
                    </DialogHeader>
                    {currentCourse && (
                        <div className="grid gap-4 py-4">
                            <div className="grid gap-2">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="grid gap-2">
                                    <Label htmlFor="edit-hours">Training Hours</Label>
                ...
                <Dialog open={isDetailOpen} onOpenChange={setIsDetailOpen}>
                    <DialogContent className="max-w-4xl bg-background/95 backdrop-blur-xl">
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Comprehensive overview of the Teacher Development course
                            </DialogDescription>
                        </DialogHeader>
                                ...
                                <CardContent className="p-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="space-y-2">
                                            <Label className="text-xs text-muted-foreground font-semibold capitalize tracking-wider">Course Title</Label>
                                            <p className="text-lg font-semibold text-foreground">{detailCourse.title}</p>
                                        </div>

                                        <div className="space-y-2">
                                            <Label className="text-xs text-muted-foreground font-semibold capitalize tracking-wider">Category</Label>
                                            <div>
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-xs text-muted-foreground font-semibold capitalize tracking-wider">Instructor</Label>
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-xs text-muted-foreground font-semibold capitalize tracking-wider">Total Enrolled</Label>
                                            <Button
                                                variant="ghost"
                                        ...
                                        {detailCourse.url && (
                                            <div className="space-y-2 col-span-2">
                                                <Label className="text-xs text-muted-foreground font-semibold capitalize tracking-wider">Course Link</Label>
                                                <div className="flex items-center gap-2">
                                                    <a
                                    ...
                                    <CardContent className="p-6">
                                        ...
                                        <div className="overflow-x-auto">
                                            <Table>
                                                ...
                                                <TableBody>
                                                    {mockEnrolledMembers[detailCourse.id as keyof typeof mockEnrolledMembers].map((member: any, index: number) => (
