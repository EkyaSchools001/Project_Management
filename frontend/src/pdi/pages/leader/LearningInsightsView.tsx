...
import { learningFestivalService, LearningFestivalApplication } from '@pdi/services/learningFestivalService';
        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <PageHeader
                    ...
                    subtitle={`Campus-wide Teacher Development overview for ${user?.campusId || 'your campus'}.`}
                />
                        ...
                        <Card className="bg-gradient-to-br from-blue-50 to-white shadow-sm  ">
                            <CardContent className="p-6">
                                <div className="flex justify-between items-start">
                                    <div>
                                        <p className="text-sm font-bold text-gray-500 capitalize">Campus Average Engagement</p>
                        ...
                        <CardContent className="p-6 flex flex-col md:flex-row gap-6 justify-between items-center">
                            ...
                            <div className="flex gap-8">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-xs font-bold text-yellow-500 capitalize tracking-wider">Pending Review</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="space-y-6 py-4 text-sm">
                            <div className="space-y-2">
                                <p className="font-bold text-gray-500 capitalize">Preferred Strand</p>
                                <p className="font-medium text-gray-900">{selectedApp.preferredStrand || 'None Selected'}</p>
                            </div>
                            <div className="space-y-2">
                                <p className="font-bold text-gray-500 capitalize">Statement of Purpose</p>
