...
Format the output in clear, professional text with appropriate headers. Do NOT use markdown bold markers like **text**. Use plain text for emphasis where needed. Keep it professional and encouraging.`;
...
2. Assessment Workshop: Prioritize the upcoming "Digital Literacy" workshop to enhance assessment diversity.
...
### Actionable Roadmap
1. Targeted PD: Focus next month's Teacher Development on "Data-Driven Feedback" to address the assessment variance.
