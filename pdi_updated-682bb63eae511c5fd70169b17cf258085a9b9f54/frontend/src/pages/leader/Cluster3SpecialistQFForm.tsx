...
// ── Specialist Rubric Definition (Cluster 3 ONLY) ──────────────────────────────
const SUBDOMAINS = [
  {
    code: "1", title: "Planning & Preparation",
    params: [
      { id: "1e", name: "1e Coherent Lesson Design", desc: "", lookFor: "" },
    ],
  },
  {
    code: "2", title: "Learning Environment",
    params: [
      { id: "2b", name: "2b Culture for Learning", desc: "", lookFor: "" },
    ],
  },
  {
    code: "3", title: "Learning Experiences",
    params: [
      { id: "3a", name: "3a Communication", desc: "", lookFor: "" },
      { id: "3b", name: "3b Questioning & Discussion", desc: "", lookFor: "" },
      { id: "3c", name: "3c Engagement", desc: "", lookFor: "" },
      { id: "3e", name: "3e Responsiveness", desc: "", lookFor: "" },
    ],
  },
];
...
// ── Main Page ──────────────────────────────────────────────────────────────────
const Cluster3SpecialistQFForm: React.FC = () => {
  ...
  const buildPayload = (status: "DRAFT" | "SUBMITTED") => ({
    ...
    observerId: user?.id,
    date,
    domain: "Cluster 3 - Intellectual Engagement (Specialist)",
    type: "specialist-qf",
    status,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Cluster 3 Specialist Observation submitted!");
      navigate(-1);
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 pt-6">
          <div className="relative h-[200px] md:h-[240px] overflow-hidden rounded-[2.5rem] shadow-2xl mb-8 bg-[#EA104A]">
            ...
            <div className="absolute inset-0 flex flex-col justify-center pl-10 md:pl-16">
              ...
              <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter leading-[0.9] uppercase drop-shadow-2xl">Cluster 3 – Specialist Form</h1>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border-none shadow-lg rounded-2xl">
              <CardHeader className="border-b bg-slate-50/50 rounded-t-2xl">
                <CardTitle className="text-lg font-bold flex items-center gap-2">
                  <Info className="w-5 h-5 text-blue-600" /> Session Details
                </CardTitle>
              </CardHeader>
              <CardContent className="p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="md:col-span-3 space-y-1.5">
                  ...
                  <label className="flex items-center gap-3 border-2 border-dashed border-slate-200 rounded-xl p-4 cursor-pointer hover:border-blue-400 transition-colors">
              ...
              <Card key={sd.code} className="border-none shadow-lg rounded-2xl overflow-hidden">
                <CardHeader className="bg-[#1F2839] text-white py-4 px-6">
                  <CardTitle className="font-black text-lg text-white">
                    <span className="text-blue-400 mr-2">Domain {sd.code}</span>{sd.title}
                  </CardTitle>
                </CardHeader>
            ...
            <Card className="border-none shadow-lg rounded-2xl">
              <CardHeader className="border-b bg-slate-50/50">
                <CardTitle className="text-lg font-bold">Glows & Grows (Cluster 3 Only)</CardTitle>
              </CardHeader>
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-4 pt-4">
              <Button
                className="w-full sm:w-64 h-12 rounded-xl font-bold gap-2 bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-200"
...
export default Cluster3SpecialistQFForm;
