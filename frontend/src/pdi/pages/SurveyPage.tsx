...
import { surveyService, Survey, SurveyResponse } from '@pdi/services/surveyService';
import { SurveyWizard } from '@pdi/components/survey/SurveyWizard';
import { SurveyResponseView } from '@pdi/components/survey/SurveyResponseView';
import { SurveyAnalyticsDashboard } from '@pdi/components/survey/SurveyAnalyticsDashboard';
import { SurveyHistoryView } from '@pdi/components/survey/SurveyHistoryView';
import { Loader2, AlertCircle, ClipboardList } from 'lucide-react';
import { Alert, AlertDescription, AlertTitle } from '@pdi/components/ui/alert';
...
const SurveyPage = () => {
    ...
    if (['ADMIN', 'MANAGEMENT', 'SUPERADMIN'].includes(user?.role || '')) {
            ...
            return (
                <div className="p-8">
                    <Alert>
                        ...
                        <AlertDescription>
                            There are currently no Teacher Development surveys in the system. Please seed the database or create one manually.
                        </AlertDescription>
                    </Alert>
                </div>
            );
        ...
        return (
            <div className="p-6">
                <SurveyAnalyticsDashboard survey={survey} onRefreshSurvey={fetchSurveyData} />
            </div>
        );
    }
        ...
        return (
            <div className="p-8">
                ...
                <Alert>
                    ...
                    <AlertDescription>
                        There are currently no active Teacher Development surveys. Please check back later.
                    </AlertDescription>
                </Alert>
            </div>
        );
    ...
    if (myResponse?.isCompleted && !isEditing && !isRetaking) {
        return (
            <div className="pb-6">
                <Header />
                <div className="px-6">
    ...
    return (
        <div className="min-h-screen pb-6">
            ...
            <div className="px-4 md:px-6">
                <SurveyWizard
                    survey={survey}
                    initialAnswers={isRetaking ? undefined : myResponse?.answers}
