            ...
            <header className="flex flex-col xl:flex-row justify-between items-start xl:items-end gap-12 relative overflow-hidden p-12 sm:p-16 lg:p-24 bg-zinc-900 rounded-[5rem] text-white shadow-2xl group border border-white/5">
                ...
                <div className="flex items-center gap-10 bg-white/5 backdrop-blur-3xl border border-white/10 px-12 h-28 py-10 rounded-[3rem] shadow-2xl shadow-black/20 w-full xl:w-auto relative z-10 group-hover:bg-white/10 transition-all duration-700">
                    <div className="space-y-1">
                        <p className="text-[10px] font-black text-white/40 uppercase tracking-[0.4em]">Integrated Nodes</p>
                        <div className="flex items-baseline gap-4">
                            <span className="text-6xl font-black text-indigo-400 tracking-tighter">{Object.values(SCHOOLS).flat().length}</span>
                            <span className="text-xl font-black text-white/20 uppercase tracking-widest">Active</span>
                        </div>
                    </div>
