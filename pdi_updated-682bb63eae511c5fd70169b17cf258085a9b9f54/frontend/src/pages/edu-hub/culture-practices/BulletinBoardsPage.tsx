...
const BulletinBoardsPage = () => {
  const navigate = useNavigate();
  const { user } = useAuth();
  const [isEditorOpen, setIsEditorOpen] = useState(false);
  
  const [data, setData] = useState({
    heroImage: "https://images.unsplash.com/photo-1456735190827-d1262f71b8a3?q=80&w=2068&auto=format&fit=crop",
    mainTitle: "Bulletin",
    italicTitle: "Boards",
    heroDesc: "Making learning visible, celebrating student work, and building a vibrant school community.",
    introText: "Bulletin boards at CMR/Ekya schools serve multiple purposes: they make learning visible, display student work and reflections, share information, and build a sense of campus belonging. Each board type has a specific audience, purpose, and owner. Maintaining boards consistently is a shared responsibility across teachers, coordinators, and specialist staff.",
    differentiation: "Grades 11–12 boards have a more student-driven format, including a Tech Corner, 'Good Reads' list, and subject-specific concept maps. Early Years boards must follow specific dos and don'ts including special guidance for literacy displays (sight words, CVC words). Ekya Mirror has dedicated sections updated by the School Counsellor, Academic Coordinator, and Career Counsellor.",
    quickTip: "Take a photo of your board at the start of each month : it documents learning, helps you track what needs updating, and creates a record of the year's progression that students love revisiting.",
    processSteps: [
      { text: "AM provides teachers with chart paper, marker pens, board pins, satin ribbons, and A4 paper at the year's start." },
      { text: "Use satin ribbons to divide boards : no borders to be used on any board." },
      { text: "Showcase Board (outside class): Display student names, photos (EY/Primary), work samples, books being read, and spotlight achievements." },
      { text: "Information Board (near chalkboard): Post the Social Contract, timetable, bus routes, affirmation corner, upcoming events, hall passes, and responsibility charts." },
      { text: "Word Wall (near chalkboard): Add new subject vocabulary on 1-inch strips; include a Parking Lot for student questions." },
      { text: "Learning Area Board: Capture the lesson's progression : topic, Enduring Understanding, Essential Questions, student work, and reflections." },
      { text: "Common Boards (PE, Clubs, VA, PA, Library, TRC, Staffroom, Reception, Ekya Mirror): Follow specific templates provided for each board type." },
      { text: "Update boards regularly : showcase boards monthly, word walls per lesson, LA boards per unit." }
    ],
    dos: [
      { text: "Populate boards by the first week of school and update them throughout the year" },
      { text: "Display student work with a short description of the activity" },
      { text: "Laminate the printed subject tags (Helvetica Bold, 80–85pt) for uniformity" },
      { text: "Use the Parking Lot on the Word Wall for unresolved student questions" },
      { text: "Ensure the Social Contract is prominently visible on the Information Board" }
    ],
    donts: [
      { text: "Don't use decorative borders on any board" },
      { text: "Don't make boards 'beautiful' at the expense of making learning visible" },
      { text: "Don't leave boards static : update them at least monthly" },
      { text: "Don't store items on top of shelves or use shelf tops as display areas" },
      { text: "Don't neglect the Ekya Mirror : it is the most visible board to parents and visitors" }
    ],
    glossary: [
      { term: "Showcase Board", mean: "The bulletin board outside the classroom displaying student introductions, work, and achievements." },
      { term: "Learning Area Board", mean: "A board capturing the progression of learning in a specific subject : topic, understanding, questions, work, and reflections." },
      { term: "Word Wall", mean: "A vocabulary display of new terms learned in all subjects, written on strips by students." },
      { term: "Enduring Understanding", mean: "A big idea central to a discipline that has lasting value beyond the specific lesson." },
      { term: "Parking Lot", mean: "A section of the Word Wall where students post learning questions for the teacher to address later." },
      { term: "Ekya Mirror", mean: "A campus-wide bulletin board showcasing school happenings, accessible to students, parents, and visitors." }
    ],
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const result = await settingsService.getSetting("page_culture_bulletin_boards");
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] pb-24 rounded-b-[2.5rem] smooth-scroll">
      <PageEditorControls 
        settingKey="page_culture_bulletin_boards"
        initialData={data}
        onSave={setData}
        title="Bulletin Boards Content"
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-24">
        ...
        <section className="space-y-12">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-sm font-black text-primary tracking-[0.3em] uppercase">{data.processSubtitle || "Board Standards"}</h2>
        ...
        <section className="space-y-12">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-sm font-black text-primary tracking-[0.3em] uppercase">{data.differentiationSubtitle || "Level Variations"}</h2>
...
export default BulletinBoardsPage;
