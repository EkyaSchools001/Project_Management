...
import * as surveyController from '../../controllers/pdi/surveyController';
...
router.get('/:surveyId/responses', restrictTo('ADMIN', 'MANAGEMENT', 'SUPERADMIN'), surveyController.getSurveyResponses);
