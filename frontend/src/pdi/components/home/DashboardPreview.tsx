            ...
            <div className="rounded-xl border bg-card/50 backdrop-blur-sm shadow-2xl overflow-hidden animate-slide-up hover:shadow-primary/10 transition-shadow duration-500">
                ...
                <div className="p-6 md:p-8 grid gap-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <Card className="bg-backgroundackground/80 backdrop-blur">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Card className="bg-backgroundackground/80 backdrop-blur col-span-1">
                            <CardHeader>
                    ...
                    {/* List Preview */}
                    <div className="rounded-lg border bg-backgroundackground/50 p-4">
