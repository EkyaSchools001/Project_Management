...
export default function GoogleSlidesPage() {
  ...
  const [data, setData] = useState({
    ...
    introContent: "Google Apps includes a powerful alternative to Powerpoint presentations called Google Slides. You can work on Google Presentations together, as a team. Since everything's stored in Google Drive you can access, edit and present from any modern browser or mobile device.",
    objectiveTitle: "OBJECTIVES OF THE TUTORIAL",
    trainingTitle: "GOOGLE TRAINING ON SLIDES",
    objectiveGroups1Title: "Create or Import",
    objectiveGroups1Text: "Create a new presentation | https://drive.google.com/file/d/18zkkvzx4YtPt5gwH9OdUir2VKjy89029/view\nImport and convert old presentations to Slides | https://drive.google.com/file/d/1j3EoKB-Tw5I0kl5Qxa9_cGRDrM_Aiu5k/view",
    objectiveGroups2Title: "Share and collaborate",
    objectiveGroups2Text: "Share presentation | https://drive.google.com/file/d/13oEScP3ZEjGg6xTdOIGbmOXATp1cGRVd/view\nAdd comments and replies | https://drive.google.com/file/d/1qb3jNpKlKU-_PBtCOIOlppv5tQ5rxbWi/view\nChat with people directly | https://drive.google.com/file/d/11f8mjcEjNSJvGnTdROPzCZZSDS-kDFMN/view",
    objectiveGroups3Title: "Add content",
    objectiveGroups3Text: "Choose a theme and layout | https://drive.google.com/file/d/1H4DenLzoDXZu5W6SKuggGaPNfpg-yCN5/view\nAdd and edit content | https://drive.google.com/file/d/18xf46Bc4qV7kaEacB4zoO5kRmZOrEnJJ/view\nCustomize your slides | https://drive.google.com/file/d/1EEBlE1sT9vTRgp3OYJJxwvX0J7HXN836/view\nCreate and arrange slides | https://drive.google.com/file/d/1pmYGEcZvLsMCrcAdVsR6cC4rW81lq1Ik/view",
    objectiveGroups4Title: "Present, print, and download",
    objectiveGroups4Text: "Present your slides | https://drive.google.com/file/d/13lh3D_qsTuSRRYKnMkxHYlw8dy5cAYBn/view\nPrint your presentation | https://drive.google.com/file/d/1H5xBPOAYhfhO9kn0AQjgdV8GSXNRcZjK/view\nDownload versions in other formats | https://drive.google.com/file/d/1sdvcE7EwImSGLwLPoE1kkTCMGSpr0ZkR/view\nMake a copy in Slides | https://drive.google.com/file/d/1qopiLsgLTvxYAJL-x5o3YPaSFQh5ia3S/view\nEmail a copy as attachment | https://drive.google.com/file/d/1sYaKb5N5OahBshDcZQFPoQUfCYkAQ_mK/view",
    trainingLinksText: "Create or import files - G Suite Learning Center | https://drive.google.com/file/d/1gnnCXZjUHxjEBlEAl_w1olqVe6hQ1ibU/view\nAdd content to your presentation - G Suite Learning Center | https://drive.google.com/file/d/1kN2wCSOtOSCklGBCEdlaz7T3gTzvuvlN/view\nShare and collaborate on files or share files with large groups of people - G Suite Learning Center | https://drive.google.com/file/d/1zW9dCSuGZ13X8GpnA3HrTuu3EhmsjLPz/view\nPrint and download files - G Suite Learning Center | https://drive.google.com/file/d/195Ctp5CsVesDUy-P_6ioQi2d3pbkUBqo/view\nAccess your calendar, notes, and tasks - G Suite Learning Center | https://drive.google.com/file/d/1MdJ-pWTTTnZTA-vCUn95vwHGVOwzugnM/view\nGive a presentation with Slides - G Suite Learning Center | https://drive.google.com/file/d/1UZFlWiLC98CWwwcLAFtNeoLngHBNbObA/view"
  });

  useEffect(() => {
    const fetchData = async () => {
      try {
        const result = await settingsService.getSetting("page_tech_google_slides");
  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      <PageEditorControls 
        settingKey="page_tech_google_slides"
        initialData={data}
        onSave={setData}
        title="Edit Google Slides Page"
      ...
      <PortalBanner 
        ...
        subtitle="Create, edit, and collaborate on presentations live with Google Slides."
        onBack={() => navigate(-1)}
