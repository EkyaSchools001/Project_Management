...
const AnnualDayPage = () => {
  ...
  const [data, setData] = useState({
    heroImage: "https://images.unsplash.com/photo-1514525253361-bee8d48800d0?q=80&w=2070&auto=format&fit=crop",
    mainTitle: "Annual",
    italicTitle: "Day",
    heroDesc: "Showcasing student talent and school spirit through a celebratory year-end performance.",
    introText: "Annual Day at CMR/Ekya Schools is a yearly showcase event (1 to 1.5 hours long) where students perform on stage through dance, drama, narration, and music. It builds confidence, teamwork, and leadership skills while creating lasting memories. Planning begins months in advance with clear task ownership across the HoS, Coordinators, and teachers.",
    differentiation: "PA teachers handle dance training; VA teachers manage props; English teachers coach narrators; Choir teachers handle music; subject teachers coach actors. Student Council members from senior grades assist with prop movement. Coordinators may host as MC: the MC script must be reviewed and approved by the HoS before practice begins.",
    quickTip: "Create a shared 'Annual Day Master Tracker' spreadsheet with all key tasks, owners, and dates: review it at every planning meeting so no detail falls through the cracks as the event approaches.",
    processSteps: [
      { text: "At the year's start: Decide event date, participating grades, and theme (historical, mythological, values-based, etc.)." },
      { text: "2 months before: Finalise script, allocate teachers for training (PA-dance, VA-props, English-narration, Choir-music, Subject-acting)." },
      { text: "Get script approved by HoS; draft and approve budget with HoS and TO." },
      { text: "Identify vendors (costumes, stage, light, sound); send parent email about costumes and payment." },
      { text: "1–1.5 months before: Begin daily practice (1 hour); identify and invite Chief Guest." },
      { text: "1 week before: Stage rehearsal with props, light, and music; check costumes on students with vendor present." },
      { text: "Day before: Get venue ready with posters, banners, props; complete seating arrangements." },
      { text: "Day of event: Check sound/lights, welcome guests, run programme (Welcome → Lamp → Invocation → Annual Report → Chief Guest → Cultural Programme → Vote of Thanks → National Anthem → Dispersal)." }
    ],
    dos: [
      { text: "Begin planning at least 3 months before the event" },
      { text: "Send parent communication with clear costume details and payment information" },
      { text: "Have a stage rehearsal at least 3 days before the event" },
      { text: "Prepare the MC script in advance and get it reviewed by HoS" },
      { text: "Maintain an Excel tracker: student names, class, role, costume, payment status" }
    ],
    donts: [
      { text: "Don't start costume procurement without HoS-approved budget" },
      { text: "Don't leave sound, lighting, or seating for the day of the event" },
      { text: "Don't allow student participation without confirming their role in writing to parents" },
      { text: "Don't skip the MC script review : live events require preparation" },
      { text: "Don't forget dispersal planning : inform parents in writing about pick-up timings" }
    ],
    glossary: [
      { term: "MC (Main Compere)", mean: "The host of the Annual Day event: typically a Coordinator who guides the programme flow." },
      { term: "Chief Guest", mean: "An invited dignitary who addresses the gathering and participates in key ceremonial moments." },
      { term: "Investiture Ceremony", mean: "The formal ceremony where Student Council members receive their Leadership Badges." },
      { term: "Invocation", mean: "An opening song or dance that marks the formal start of a school event." },
      { term: "VA (Visual Arts)", mean: "The Visual Arts department : responsible for creating props and stage décor for the Annual Day." }
    ],
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const result = await settingsService.getSetting("page_culture_annual_day");
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] pb-24 rounded-b-[2.5rem] smooth-scroll">
      <PageEditorControls 
        settingKey="page_culture_annual_day"
        initialData={data}
        onSave={setData}
        title="Annual Day Content"
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-24">
        ...
        <section className="space-y-12">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-sm font-black text-primary tracking-[0.3em] uppercase">{data.processSubtitle || "Timeline & Roadmap"}</h2>
        ...
        <section className="space-y-12">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-sm font-black text-primary tracking-[0.3em] uppercase">{data.differentiationSubtitle || "Task Ownership"}</h2>
