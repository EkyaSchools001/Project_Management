...
router.post('/upsert', protect, restrictTo('ADMIN', 'SUPERADMIN', 'TESTER', 'LEADER'), settingsController.upsertSetting);
router.delete('/:key', protect, restrictTo('ADMIN', 'SUPERADMIN', 'TESTER', 'LEADER'), settingsController.deleteSetting);
