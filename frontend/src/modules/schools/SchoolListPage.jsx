                        ...
                        {category.schools.map((school, schoolIndex) => (
                            ...
                            >
                                <Card className="group relative overflow-hidden bg-[#111c2a] hover:border-brand-300">
                                    <div className="absolute top-0 right-0 w-24 h-24 bg-backgroundrand-50 rounded-bl-full flex items-center justify-center -mr-12 -mt-12 transition-transform group-hover:scale-110">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="pt-4 flex items-center justify-between border-t border-neutral-800">
                                            ...
                                            <button className="p-2 text-brand-600 hover:bg-backgroundrand-50 rounded-lg transition-colors">
