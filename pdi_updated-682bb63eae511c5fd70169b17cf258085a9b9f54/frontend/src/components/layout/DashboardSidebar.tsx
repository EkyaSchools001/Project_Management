...
export function DashboardSidebar({
  ...
  const getNavByRole = (role: string): SidebarModule[] => {
    ...
    const eduHubSubModules = [
      ...
      { title: "Culture & environment", path: "/edu-hub/culture-environment", icon: Globe },
      { title: "Co-Curricular", path: "/edu-hub/co-curricular", icon: Palette },
      { title: "LAC", path: "/edu-hub/lac", icon: ClipboardText },
    ];
    ...
    >
      ...
      <div className="p-3 border-t border-sidebar-border shrink-0">
        <NavLink
          to="/"
          className={cn(
            "flex items-center rounded-lg transition-colors group overflow-hidden",
