...
import { Heart, Plus, Search, Calendar, Star, Eye } from "lucide-react";
...
const LifeSkillsObsDashboard: React.FC = () => {
    const { user } = useAuth();
    ...
    let newPath = "/leader/life-skills-obs/new";
    if (teacherId) {
            ...
            <div className="animate-in fade-in duration-500" style={{ background: "#F5F5EF", minHeight: "100vh", padding: "0 0 40px" }}>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold" style={{ color: "#1F2839" }}>Life Skills Observation</h1>
                            <p className="text-sm text-muted-foreground">AY 25-26 Life Skills Observation_Master</p>
                        </div>
                    </div>
                    <Button
                    ...
                    <CardContent className="p-0">
                        {loading ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-16 gap-3 text-muted-foreground">
                                ...
                                <p className="font-medium">No life skills observations yet</p>
                            ...
                            filtered.map((obs, idx) => (
                                <div
                                    ...
                                    onClick={() => navigate(`/leader/life-skills-obs/new?teacherId=${obs.teacherId || obs.teacherEmail}&id=${obs.id}`)}
                                >
                                    ...
                                    <span className="col-span-2" onClick={(e) => e.stopPropagation()}>
                                        <Button
                                            ...
                                            onClick={() => navigate(`/leader/life-skills-obs/new?teacherId=${obs.teacherId}&id=${obs.id}&mode=view`)}
                                        >
...
export default LifeSkillsObsDashboard;
