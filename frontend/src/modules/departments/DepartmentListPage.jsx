                ...
                {departments.map((dept, index) => (
                    ...
                    >
                        <Card className="p-0 overflow-hidden flex flex-col h-full border-white/50 border">
                            ...
                            <div className="px-6 py-4 bg-[#0f172a]/50 border-t border-neutral-800 flex items-center justify-between group cursor-pointer hover:bg-brand-50 transition-colors">
