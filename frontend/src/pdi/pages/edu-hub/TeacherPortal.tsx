  ...
  const sections: Record<string, React.ReactNode> = {
    home: (
      <div className="space-y-0 pb-12">
        ...
        <div className="relative w-full h-[280px] overflow-hidden -mt-6 -mx-8 md:-mx-12 rounded-b-[3rem] shadow-2xl mb-12">
          <div className="absolute inset-0 bg-slate-900">
            <img 
              src="https://images.unsplash.com/photo-1524178232363-1fb2b075b655?q=80&w=2070&auto=format&fit=crop" 
              alt="Educator Journey"
              className="w-full h-full object-cover opacity-50 mix-blend-luminosity transform scale-110 hover:scale-100 transition-transform duration-[10000ms]"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/40 to-transparent" />
            <div className="absolute inset-0 bg-gradient-to-r from-primary/20 to-transparent" />
          </div>
          
          <div className="absolute inset-0 flex flex-col justify-end px-8 md:px-12 pb-12 max-w-7xl mx-auto">
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-4 lg:grid-cols-3">
              {[
                ...
                { title: 'My classroom', icon: ChalkboardTeacher, desc: 'Attendance, student lists, micro plans, environment, and records — everything daily.', bar: 'bg-gradient-to-r from-blue-400 to-blue-600 shadow-[0_0_10px_rgba(96,165,250,0.5)]', path: '/departments/pd/edu-hub/my-classroom' },
                ...
                <div 
                  ...
                  className="bg-white/50 backdrop-blur-lg border border-white/50 shadow-sm rounded-2xl p-8 group cursor-pointer relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:bg-white/80 hover:-translate-y-1 hover:border-primary/20"
                >
        ...
        <div className="px-6 py-12 sm:px-12 relative z-20">
          <div className="mx-auto max-w-7xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border border-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.2)] p-8 rounded-[2.5rem]">
        ...
        <PageHeader 
          ...
          onBack={() => {
            if (activeTeachingView === 'la') {
              ...
              navigate('/departments/pd/edu-hub');
            }
          }}
        />
    ...
    classroom: (
      <div className="space-y-8 pb-12 text-slate-900">
        <PageHeader 
          ...
          onBack={() => navigate('/departments/pd/edu-hub')}
        />
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-6 lg:grid-cols-3">
              {[
                ...
                <div key={card.title} className="bg-white/50 backdrop-blur-lg border border-white/50 shadow-sm rounded-2xl p-6 group cursor-pointer transition-all duration-300 hover:shadow-xl hover:bg-white/80 hover:-translate-y-1 hover:border-primary/20">
            ...
            {[
              {
                ...
                path: "/departments/pd/educator-hub/institutional-identity/philosophy"
              },
              {
                ...
                path: "/departments/pd/educator-hub/institutional-identity/legacy"
              },
              {
              ...
              },
              {
                ...
                path: "/departments/pd/educator-hub/institutional-identity/schools"
              }
            ].map((card) => (
              <div 
                key={card.title} 
                onClick={() => navigate(card.path)}
                className="bg-white rounded-[2.5rem] p-8 md:p-10 shadow-sm border border-slate-100 hover:shadow-lg hover:border-primary/20 hover:-translate-y-1 cursor-pointer transition-all duration-300 flex flex-col gap-8 group relative overflow-hidden"
              >
