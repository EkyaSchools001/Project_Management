...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue, SelectGroup, SelectLabel, SelectSeparator } from "@pdi/components/ui/select";
import { HoverCard, HoverCardContent, HoverCardTrigger } from "@pdi/components/ui/hover-card";
...
export function FormWorkflowsConfig() {
    ...
    const updateLogicDescription = (workflow: FormWorkflow) => {
        ...
        const schoolText = workflow.targetSchool && workflow.targetSchool !== 'ALL' ? ` at ${workflow.targetSchool}` : '';
                        ...
                        <Card key={flow.id} className="border-violet-300 shadow-sm relative overflow-hidden bg-white">
                            ...
                            <CardContent className="p-4 space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-4 flex-1">
                                        ...
                                        <div className="flex-1 flex gap-4">
                                            <div className="w-40">
                                                <label className="text-xs font-semibold text-gray-500 capitalize">Subject Type</label>
                                            ...
                                            <div className="flex-1">
                                                <label className="text-xs font-semibold text-gray-500 capitalize">Specific Subjects</label>
                                ...
                                <div className="flex items-end gap-3 pt-2">
                                    <div className="w-32">
                                        <label className="text-xs font-semibold text-gray-500 capitalize">Target School</label>
                                    ...
                                    <div className="w-32">
                                        <label className="text-xs font-semibold text-gray-500 capitalize">Sent By</label>
                                    ...
                                    <div className="flex-1">
                                        <label className="text-xs font-semibold text-gray-500 capitalize">Redirect To Dashboard</label>
                                    ...
                                    <div className="flex-1">
                                        <label className="text-xs font-semibold text-gray-500 capitalize">Response Display Location</label>
