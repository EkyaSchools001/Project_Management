...
export function DashboardLayout() {
    ...
    return (
        <div className="h-screen w-full flex bg-backgroundackground text-foreground font-sans selection:bg-primary/20 selection:text-primary overflow-hidden">
            {mobileOpen && (
                <div
                    className="fixed inset-0 bg-backgroundackground/10 backdrop-blur-[2px] z-40 lg:hidden transition-opacity"
            ...
            <main className="flex-1 flex flex-col min-w-0 relative bg-backgroundackground">
