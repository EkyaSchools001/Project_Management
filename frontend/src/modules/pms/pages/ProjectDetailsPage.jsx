        ...
        >
                ...
                <div className="flex flex-col xl:flex-row justify-between items-start gap-16 relative z-10">
                    <div className="flex-1 space-y-12">
                        <motion.button
                            ...
                            className="group flex items-center text-[11px] font-black text-white/40 hover:text-indigo-400 transition-all uppercase tracking-[0.4em] active:scale-95"
                        >
                        ...
                        <div className="space-y-8">
                            ...
                            <motion.p variants={itemVariants} className="text-white/40 max-w-4xl text-lg sm:text-2xl font-black uppercase tracking-widest leading-relaxed border-l-8 border-white/10 pl-10">
                                {project.description}
                            </motion.p>
                        </div>

                        <div className="flex flex-wrap gap-8 pt-10">
                            <StatBadge icon={User} label="Command Lead" value={project.manager.name} color="text-blue-400" bg="bg-blue-600/10" />
                    ...
                    >
                        ...
                        <p className="text-[11px] font-black text-white/40 uppercase tracking-[0.5em] relative z-10">Integration Velocity</p>
                        <div className="relative w-56 h-56 relative z-10">
                            <svg className="w-full h-full transform -rotate-90">
                                <circle cx="112" cy="112" r="100" stroke="currentColor" strokeWidth="20" fill="transparent" className="text-white/5" />
                                <motion.circle
                        ...
                        <div className="space-y-4 relative z-10">
                            <p className="text-base font-black text-white uppercase tracking-widest">{tasks.length} Atomic Work Units</p>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
                ...
                <button
                    ...
                    className="h-20 px-12 bg-slate-950 text-white rounded-[2rem] text-xs font-black uppercase tracking-[0.3em] shadow-[0_30px_60px_rgba(0,0,0,0.2)] hover:bg-indigo-600 hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-6 shrink-0 group/deploy"
                >
...
const StatBadge = ({ icon: Icon, label, value, color, bg }) => (
    <div className="flex items-center gap-6 px-10 py-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2.5rem] hover:bg-white/10 hover:border-white/20 transition-all group/stat cursor-default">
        ...
        <div className="flex flex-col">
            <span className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em] mb-2">{label}</span>
            <span className="text-xl font-black text-white tracking-tight leading-none group-hover/stat:text-indigo-400 transition-colors uppercase tracking-widest">{value}</span>
        </div>
    </div>
);
                                ...
                                <Card className="p-10 hover:shadow-[0_45px_100px_rgba(0,0,0,0.1)] hover:border-indigo-500 hover:-translate-y-3 transition-all duration-700 cursor-pointer bg-white border border-slate-100 rounded-[3rem] group/card relative overflow-hidden">
                                    ...
                                    <div className="flex items-center gap-6 mt-10 pt-10 border-t border-slate-50 group-hover/card:border-indigo-50">
                                        <div className="flex -space-x-4">
                                            <div className="w-12 h-12 rounded-[1.25rem] bg-slate-950 text-white border-4 border-white flex items-center justify-center text-[12px] font-black uppercase shadow-2xl group-hover/card:bg-indigo-600 group-hover/card:scale-115 transition-all">
    ...
    <Card className="overflow-hidden border-none shadow-[0_45px_100px_rgba(0,0,0,0.1)] rounded-[4rem] bg-white relative">
        ...
        <div className="overflow-x-auto relative z-10">
            <table className="w-full text-left border-collapse">
                <thead>
                    <tr className="bg-slate-950 text-white border-b border-white/5">
                        ...
                        <tr key={task.id} className="hover:bg-indigo-50/50 transition-all cursor-pointer group">
                            <td className="px-12 py-10">
                                <div className="flex items-center gap-8">
                                    <div className={`w-14 h-14 rounded-[1.5rem] flex items-center justify-center transition-all duration-700 shadow-2xl ${task.status === 'Done' ? 'bg-emerald-50 text-emerald-500 border border-emerald-100' : 'bg-slate-50 text-slate-300 group-hover:bg-indigo-600 group-hover:text-white border border-slate-100 group-hover:rotate-12'}`}>
        ...
        <Card className="p-12 border-indigo-200 bg-indigo-50 lg:col-span-2 xl:col-span-1 relative overflow-hidden group/team cursor-default rounded-[4rem] shadow-2xl hover:shadow-[0_45px_100px_rgba(0,0,0,0.1)] transition-all duration-700">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-10 relative z-10 text-center sm:text-left">
                <div className="relative">
                    <div className="w-32 h-32 rounded-[2.5rem] bg-slate-950 text-white flex items-center justify-center text-5xl font-black shadow-[0_30px_60px_rgba(0,0,0,0.3)] group-hover/team:scale-110 group-hover/team:bg-indigo-600 transition-all duration-700 relative z-10 border-4 border-white/20">
                        {manager.name.charAt(0)}
                    </div>
                    <div className="absolute -bottom-4 -right-4 w-12 h-12 rounded-[1.5rem] bg-indigo-500 text-white flex items-center justify-center border-4 border-indigo-50 shadow-2xl z-20 animate-pulse">
                        <Zap size={24} />
                    </div>
                </div>
