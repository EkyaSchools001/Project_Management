...
export function BudgetCard({ budget, onClick }: BudgetCardProps) {
  ...
  return (
    <div 
      onClick={onClick}
      className="bg-[#1a1d24] rounded-2xl p-6 border border-white/5 cursor-pointer hover:border-[#ef4444]/30 transition-all"
    >
      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-between text-sm">
          ...
          <span className={`font-bold ${isOverBudget ? 'text-red-500' : 'text-red-500'}`}>
