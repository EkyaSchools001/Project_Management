    ...
    <div className="min-h-screen bg-white relative">
      ...
      <section>
        ...
        <div className="max-w-6xl mx-auto px-8 py-20">
          <div className="bg-slate-50 border border-slate-100 rounded-3xl p-10 shadow-sm transition-all hover:bg-slate-100/50">
        ...
        <div className="max-w-6xl mx-auto px-8 py-20">
          <div className="space-y-10 leading-relaxed text-slate-700 font-medium text-lg">
            ...
            <div className="bg-white border-2 border-primary/20 rounded-3xl p-10 shadow-lg space-y-6 relative overflow-hidden group">
              ...
              <div className="flex items-center gap-4 text-2xl font-black text-slate-900 bg-slate-50 p-6 rounded-2xl border border-slate-100 w-fit">
