                            ...
                            filtered.map((obs, idx) => {
                                ...
                                return (
                                    <div
                                        ...
                                        onClick={() => navigate(`/leader/danielson-framework/new?teacherId=${obs.teacherId || (typeof obs.teacher === 'object' ? obs.teacher?.id : '')}&id=${obs.id}`)}
                                    >
                                        ...
                                        <span className="col-span-2" onClick={(e) => e.stopPropagation()}>
                                            <Button
                                                ...
                                                onClick={() => navigate(`/leader/danielson-framework/new?teacherId=${obs.teacherId || (typeof obs.teacher === 'object' ? obs.teacher?.id : '')}&id=${obs.id}&mode=view`)}
                                            >
