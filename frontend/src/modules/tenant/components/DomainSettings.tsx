            ...
            <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        className="px-6 py-3 bg-[#BAFF00] text-black rounded-lg hover:bg-[#a8ed00] transition-colors"
                    >
                        Save
                    </button>
                </div>
            ...
            {domain && (
                <div className="p-6 bg-white/5 rounded-xl border border-white/10">
                    ...
                    {verificationStatus === 'verified' && (
                        <div className="mt-4 flex items-center gap-2 p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                            <Check className="w-5 h-5 text-green-400" />
                            <span className="text-sm text-green-400">Domain verified successfully</span>
                        </div>
                    )}
