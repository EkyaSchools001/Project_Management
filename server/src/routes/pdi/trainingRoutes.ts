...
import { getAllTrainingEvents, getTrainingEvent, createTrainingEvent, registerForEvent, updateEventStatus, deleteTrainingEvent, updateTrainingEvent } from '../../controllers/pdi/trainingController';
