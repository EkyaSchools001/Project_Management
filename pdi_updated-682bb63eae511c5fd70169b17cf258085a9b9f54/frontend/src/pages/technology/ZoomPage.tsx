  ...
  return (
    <div className="min-h-screen bg-white pb-20 relative">
      ...
      <div className="max-w-6xl mx-auto px-8 py-16 space-y-24">
        {/* Intro */}
        <section className="bg-slate-50 p-10 rounded-3xl border border-primary/20 shadow-sm">
            ...
            {(data.tutorialsText || "").split('\n').filter(l => l.includes('|')).map((line, i) => {
              ...
              return (
                <a 
                  ...
                  className="group flex flex-col p-6 bg-white border border-primary/20 rounded-2xl shadow-sm hover:shadow-md hover:-translate-y-1 transition-all"
                >
                  <div className="flex items-center gap-4">
              ...
              {(data.toolsText || "").split('\n').filter(l => l.includes('|')).map((line, i) => {
                ...
                return (
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex flex-col p-6 bg-slate-50 border border-primary/20 rounded-2xl space-y-2 hover:bg-slate-100 transition-colors"
                  >
