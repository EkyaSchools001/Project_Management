...
export function AdminReportsView() {
    ...
    const [timeRange, setTimeRange] = useState(searchParams.get("timeRange") || "6m");
    ...
    const analyticsData = {
        userGrowth: stats?.overviewTrendData || userGrowthData,
        campusActivity: stats?.campusBenchmarking?.filter((c: any) => selectedSchool === "all" || c.campus === selectedSchool).map((c: any) => ({
            name: c.campus,
            observations: c.rawCount || 0, // We might need to adjust mapping
            goals: c.totalGoals || 0
        })) || campusActivityData,
        courseDistribution: stats?.pillarGoalDistribution || courseDistributionData,
    ...
    return (
        <GrowthLayout allowedRoles={["ADMIN", "SUPERADMIN", "MANAGEMENT", "LEADER", "SCHOOL_LEADER"]}>
                    ...
                    <Card className="col-span-1 lg:col-span-4">
                        <CardHeader>
                            ...
                            <div className="text-sm text-muted-foreground">
                                Real-time cumulative growth of users, teachers, and professional goals.
                            </div>
                        </CardHeader>
