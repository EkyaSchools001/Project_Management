          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div className="flex items-center gap-2 flex-wrap">
              {[
                ...
                <button
                  key={item.label}
                  className="flex items-center gap-2.5 px-4 py-2 rounded-full text-xs font-semibold text-slate-700 bg-white shadow-[0_2px_8px_rgba(247,53,88,0.06)] hover:shadow-[0_4px_12px_rgba(247,53,88,0.1)] hover:-translate-y-0.5 transition-all duration-300 border border-primary/20"
                >
