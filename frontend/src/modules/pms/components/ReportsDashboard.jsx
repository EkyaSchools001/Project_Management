                    ...
                    {[45, 78, 52, 92, 68, 85, 58].map((h, i) => (
                        <div key={i} className="flex-1 flex flex-col items-center gap-4 group/bar">
                            <motion.div
                                ...
                                className="w-full bg-slate-50 border border-slate-100 rounded-2xl relative overflow-hidden group-hover/bar:bg-blue-600 group-hover/bar:border-blue-500 transition-all duration-500 shadow-inner"
                            >
                                ...
                                <div className="absolute top-4 left-1/2 -translate-x-1/2 text-[10px] font-black text-blue-600 opacity-0 group-hover/bar:opacity-100 group-hover/bar:text-white transition-all tabular-nums">
                                    {h}%
                                </div>
                            </motion.div>
                        </div>
                ...
                <div className="space-y-4">
                    {[
                        ...
                        <Card key={i} className="flex items-center justify-between p-6 bg-white border border-slate-100 rounded-[2rem] hover:border-blue-500 hover:shadow-2xl hover:shadow-blue-600/5 group cursor-pointer transition-all duration-300">
                            ...
                            <button className="w-12 h-12 rounded-xl bg-slate-50 text-slate-300 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 flex items-center justify-center active:scale-90">
                                <Download size={18} />
                            </button>
                        </Card>
                    ))}
