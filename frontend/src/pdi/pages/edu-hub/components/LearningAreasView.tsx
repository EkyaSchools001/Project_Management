                        ...
                        {items.length > 0 ? (
                          <div className="grid gap-3 sm:grid-cols-2">
                            {items.map((item: string) => (
                              <div
                                key={item}
                                className="flex cursor-pointer items-center justify-between rounded-2xl bg-white border border-slate-100 px-4 py-3 transition-all duration-200 hover:shadow-md hover:border-primary/20 hover:scale-[1.02] group/item"
                              >
