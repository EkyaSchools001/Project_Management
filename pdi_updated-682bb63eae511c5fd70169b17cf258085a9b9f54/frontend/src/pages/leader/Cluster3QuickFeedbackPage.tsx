...
// ── Cluster 3 Rubric Definition ────────────────────────────────────────────────
const SUBDOMAINS = [
  {
    code: "1e", title: "Planning Coherent Instruction",
    params: [
      { id: "1e_1", name: "Coherent Lesson Design", desc: "Lesson design is coherent and connected.", lookFor: "Clear learning path." },
      { id: "1e_2", name: "Deep Learning Experiences", desc: "Experiences foster deep understanding.", lookFor: "Meaningful tasks." }
    ]
  },
  {
    code: "2b", title: "Fostering a Culture for Learning",
    params: [
      { id: "2b_1", name: "High Expectations and Safe Learning Environment", desc: "Expectations are high, environment is safe.", lookFor: "Encouraging tone, rigorous tasks." },
      { id: "2b_2", name: "Student Ownership and Persistence", desc: "Students own their learning.", lookFor: "Perseverance in challenges." }
    ]
  },
  {
    code: "3a", title: "Communicating about Purpose & Content",
    params: [
      { id: "3a_1", name: "Learning Purpose and Success Criteria", desc: "Purpose and criteria are clear.", lookFor: "Students know what success looks like." },
      { id: "3a_2", name: "Clear Content Explanation and Independent Thinking", desc: "Content is explained clearly.", lookFor: "Promotes independent thought." }
    ]
  },
  {
    code: "3b", title: "Using Questioning & Discussion Techniques",
    params: [
      { id: "3b_1", name: "Deep Questioning", desc: "Questions go beyond recall.", lookFor: "Higher-order thinking questions." },
      { id: "3b_2", name: "Meaningful Student-led Discussion", desc: "Students lead the discussion.", lookFor: "Peer-to-peer dialogue." }
    ]
  },
  {
    code: "3c", title: "Engaging Students in Learning",
    params: [
      { id: "3c_1", name: "Higher-Order Learning Tasks", desc: "Tasks require complex thinking.", lookFor: "Analysis, synthesis, evaluation." },
      { id: "3c_2", name: "Notebooking", desc: "Effective use of notebooks.", lookFor: "Organized, reflective entries." }
    ]
  },
  {
    code: "3e", title: "Responding Flexibly to Student Needs",
    params: [
      { id: "3e_1", name: "Responsive Support in the Moment", desc: "Teacher adjusts instruction based on needs.", lookFor: "In-the-moment feedback." }
    ]
  }
];
...
const TOOLS = [
  ...
  "Think-Pair-Share", "Turn & Talk", "Wait Time", 
  "Quick Draw / Quick Write", "Show Call", "Round Table Discussion", 
  "T-Chart", "KWL", "Parking Lot"
];

const ROUTINES = [
  "Not Applicable", "Arrival Routine", "Attendance Routine", 
  "Class Cleaning Routine", "Material Passing Routine", 
  "Departure Routine", "Grouping Routine", "Lining Up Strategies"
];
...
// ── Main Page ──────────────────────────────────────────────────────────────────
const Cluster3QuickFeedbackPage: React.FC = () => {
  ...
  const buildPayload = (status: "DRAFT" | "SUBMITTED") => ({
    ...
    observerId: user?.id,
    date,
    domain: "Cluster 3 - Intellectual Engagement",
    type: "quick-feedback",
    status,
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 pt-6">
          <div className="relative h-[200px] md:h-[240px] overflow-hidden rounded-[2.5rem] shadow-2xl mb-8 bg-[#EA104A]">
            ...
            <div className="absolute inset-0 flex flex-col justify-center pl-10 md:pl-16">
              ...
              <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter leading-[0.9] uppercase drop-shadow-2xl">Intellectual Engagement</h1>
              <p className="text-white/80 font-medium text-sm mt-2">Cluster 3 · Quick Feedback</p>
            </div>
          </div>
        </div>
...
export default Cluster3QuickFeedbackPage;
