...
import { getAllUsers, getUser, createUser, updateUser, deleteUser, getUnverifiedUsers, verifyUser, denyUser } from '../controllers/userController';
...
router.use(restrictTo('ADMIN', 'SUPERADMIN', 'LEADER', 'MANAGEMENT', 'COORDINATOR'));
