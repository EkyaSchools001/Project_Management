        ...
        <section className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white border border-primary/20 rounded-[2rem] p-10 flex flex-col items-center text-center space-y-6 shadow-sm hover:shadow-xl transition-all duration-300 border-b-4 border-b-[#003399]">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white border border-primary/20 rounded-[2rem] p-10 flex flex-col items-center text-center space-y-6 shadow-sm hover:shadow-xl transition-all duration-300 border-b-4 border-b-[#EA104A]">
