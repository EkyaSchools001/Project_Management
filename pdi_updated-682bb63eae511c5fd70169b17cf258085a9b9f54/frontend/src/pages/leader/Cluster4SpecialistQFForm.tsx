...
// ── Specialist Rubric Definition (Cluster 4) ───────────────────────────────────
const SUBDOMAINS = [
  {
...
// ── Main Page ──────────────────────────────────────────────────────────────────
const Cluster4SpecialistQFForm: React.FC = () => {
  ...
  const buildPayload = (status: "DRAFT" | "SUBMITTED") => ({
    ...
    observerId: user?.id,
    date,
    domain: "Cluster 4 - Successful Learning (Specialist)",
    type: "specialist-qf",
    status,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Cluster 4 Specialist Observation submitted!");
      navigate(-1);
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 pt-6">
          <div className="relative h-[200px] md:h-[240px] overflow-hidden rounded-[2.5rem] shadow-2xl mb-8 bg-[#EA104A]">
            ...
            <div className="absolute inset-0 flex flex-col justify-center pl-10 md:pl-16">
              ...
              <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter leading-[0.9] uppercase drop-shadow-2xl">Cluster 4 – Successful Learning (Specialist)</h1>
        ...
        <div className="max-w-7xl mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="border-none shadow-lg rounded-2xl">
              <CardHeader className="border-b bg-slate-50/50 rounded-t-2xl">
                <CardTitle className="text-lg font-bold flex items-center gap-2">
                  <Info className="w-5 h-5 text-amber-600" /> Session Details
                </CardTitle>
              </CardHeader>
              ...
              <Card key={sd.code} className="border-none shadow-lg rounded-2xl overflow-hidden">
                <CardHeader className="bg-[#1F2839] text-white py-4 px-6">
                  <CardTitle className="font-black text-lg text-white">
                    <span className="text-amber-400 mr-2">Domain {sd.code}</span>{sd.title}
                  </CardTitle>
                </CardHeader>
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-4 pt-4">
              <Button
                className="w-full sm:w-64 h-12 rounded-xl font-bold gap-2 bg-amber-600 hover:bg-amber-700 text-white shadow-lg shadow-amber-200"
...
export default Cluster4SpecialistQFForm;
