...
import * as analyticsController from '../../controllers/pdi/analyticsController';
...
router.get('/management/overview', adminOnly, analyticsController.getManagementOverview);
