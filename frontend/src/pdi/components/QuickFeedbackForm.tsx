...
import {
    ...
    Check, ChevronsUpDown, Search, PenTool, ClipboardList, TrendingUp, Cloud
} from "lucide-react";
...
export function QuickFeedbackForm({ onSubmit, onAutoSave, onCancel, initialData = {}, teachers }: QuickFeedbackFormProps) {
    ...
    const { isSaving } = useAutoSave({
        ...
        enabled: !!formData.teacherId,
        localStorageKey: `pdi_quick_draft_${formData.teacherId || 'new'}`
    });
    ...
    return (
        <Card className="max-w-4xl mx-auto   shadow-2xl bg-backgroundackgroundackground/60 backdrop-blur-xl overflow-hidden rounded-[2.5rem]">
            <CardHeader className="bg-gradient-to-r from-primary/10 via-primary/5 to-background border-b p-8">
                <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-2 bg-backgroundackgroundackground/50 backdrop-blur-md px-4 py-2 rounded-2xl border border-primary/10">
                            ...
                            <span className="text-xs font-black capitalize tracking-widest text-primary ml-2">Step {step} of 3</span>
                        </div>
                    </div>
                </div>
            </CardHeader>
                        ...
                        <section className="space-y-6">
                            <div className="grid grid-cols-1 gap-6">
                                <div className="space-y-3 pt-4">
                                    <Label className="text-sm font-black capitalize tracking-widest text-primary flex items-center gap-2">
                                ...
                                <div className="space-y-3 pt-4">
                                    <Label className="text-sm font-black capitalize tracking-widest text-indigo-500 flex items-center gap-2">
            ...
            <div className="p-8 bg-muted/30 border-t flex items-center justify-between">
                <Button
                    ...
                    className="h-14 px-8 rounded-2xl text-base font-bold bg-backgroundackgroundackground/50 hover:bg-backgroundackgroundackground shadow-sm border border-muted-foreground/10"
                >
