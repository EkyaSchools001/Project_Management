...
export const getNotifications = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const notifications = await prisma.pDINotification.findMany({
            where: { userId },
...
export const markAsRead = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const notification = await prisma.pDINotification.findUnique({ where: { id } });
        ...
        const updatedNotification = await prisma.pDINotification.update({
            where: { id },
            data: { isRead: true }
        });
...
export const markAllAsRead = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        await prisma.pDINotification.updateMany({
...
export const deleteNotification = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        await prisma.pDINotification.delete({ where: { id } });
...
export const createNotification = async (data: {
    ...
    try {
        const notification = await prisma.pDINotification.create({
            data: {
                userId: data.userId,
                title: data.title,
