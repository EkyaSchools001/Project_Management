    ...
    if (loading) {
        return (
            <div className="w-full bg-white/20 h-full flex flex-col items-center justify-center gap-8 backdrop-blur-2xl border-r border-white/10">
                ...
                <div className="text-[10px] font-black uppercase tracking-[0.5em] text-indigo-400 animate-pulse">Syncing Neural Streams...</div>
            </div>
        );
    }
    ...
    return (
        <div className="w-full h-full flex flex-col bg-white overflow-hidden">
            ...
            <div className="p-8 sm:p-10 bg-slate-950 border-b border-white/5 shrink-0 relative overflow-hidden group">
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-600/20 via-transparent to-rose-600/10 opacity-50 transition-opacity duration-1000 group-hover:opacity-100" />
            ...
            <div className="p-6 bg-slate-50/50 border-b border-slate-100 shadow-sm relative z-10">
                <div className="relative group/search">
                    ...
                    <input
                        ...
                        className="w-full pl-16 pr-8 h-14 bg-white border border-slate-100 rounded-2xl text-[10px] font-black uppercase tracking-wider focus:ring-8 focus:ring-indigo-600/5 focus:border-indigo-600 outline-none transition-all placeholder:text-slate-300 shadow-inner"
                        value={searchTerm}
                    ...
                    {filteredChats.length === 0 ? (
                        ...
                        filteredChats.map((chat, i) => {
                            ...
                            return (
                                ...
                                >
                                    {isActive && (
                                        <div className="absolute inset-0 bg-gradient-to-r from-indigo-600/20 via-transparent to-transparent opacity-50" />
                                    )}
                                    
                                    <div className="flex items-center gap-5 relative z-10">
                                        <div className="relative shrink-0">
                                            <div className={`w-14 h-14 rounded-2xl overflow-hidden shadow-sm border-2 transition-all duration-500 ${isActive ? 'border-white/40 scale-110 rotate-3 shadow-indigo-500/20' : 'border-slate-100 grayscale-[0.5] group-hover:grayscale-0 group-hover:scale-105'}`}>
                                                <img
                                            ...
                                            return (
                                                <div key={role} className="space-y-6">
                                                    <div className="flex items-center gap-6 px-4">
                                                        <span className="text-[10px] font-black text-indigo-600 uppercase tracking-[0.6em] shrink-0">{role} Units</span>
                                                        <div className="h-1 bg-slate-50 flex-1 rounded-full overflow-hidden">
                                                            <div className="h-full bg-indigo-100 w-1/4 rounded-full" />
                                                        </div>
                                                    </div>
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                        {roleUsers.map((user, i) => (
                                                            <motion.button
                                                                ...
                                                                className="flex items-center gap-5 p-5 bg-slate-50/50 hover:bg-white border border-slate-100 hover:border-indigo-200 hover:shadow-2xl rounded-3xl transition-all group text-left active:scale-[0.98]"
                                                            >
