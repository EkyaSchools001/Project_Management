...
const PDHubLanding = ({ role, navigate }) => (
    ...
    >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
            {[
                ...
                <motion.div key={i} variants={itemVariants}>
                    <div className="p-12 flex flex-col gap-10 group cursor-pointer hover:shadow-[0_45px_100px_rgba(0,0,0,0.4)] hover:border-[#BAFF00]/30 transition-all duration-700 bg-backgroundackground border border-white/5 rounded-[4rem] relative overflow-hidden">
        ...
        <motion.div variants={itemVariants}>
            <div className="relative overflow-hidden bg-backgroundackground border border-white/5 rounded-[4rem] p-16 sm:p-24 flex flex-col sm:flex-row items-center justify-between gap-12 group shadow-2xl">
