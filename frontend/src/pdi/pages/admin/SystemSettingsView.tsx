...
import {
    Settings, Bell, Lock, Globe, Mail, Save, Server, Shield, Key, Smartphone, Layout, Database, School, CheckCircle2, AlertCircle, Workflow, Play, Edit, RotateCw, FileText, Activity, Users, ShieldAlert
} from "lucide-react";
                ...
                if (response.data.status === 'success') {
                    ...
                    if (mainSettings) {
                        try {
                            ...
                            console.error("Failed to parse main settings", e);
                        }
                    }
                            ...
                            <CardContent className="grid gap-6">
                                ...
                                <div className="flex items-start justify-between p-4 border rounded-lg bg-card hover:shadow-sm transition-shadow">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-lg">Microsoft 365</h4>
                                ...
                                <div className="flex items-start justify-between p-4 border rounded-lg bg-card hover:shadow-sm transition-shadow">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-lg">SIS Integration</h4>
                                ...
                                <div className="flex items-start justify-between p-4 border rounded-lg bg-card hover:shadow-sm transition-shadow">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-lg">Canvas LMS</h4>
                                ...
                                <div className="grid gap-4">
                                    {settings.automation.workflows.map((workflow) => {
                                        const getIcon = (id: string) => {
                                            switch (id) {
                                                case 'user-sync': return <Users className="w-5 h-5" />;
                                                case 'obs-feedback': return <Activity className="w-5 h-5" />;
                                                case 'weekly-report': return <FileText className="w-5 h-5" />;
                                                case 'training-reminders': return <Mail className="w-5 h-5" />;
                                                case 'doc-expiry': return <ShieldAlert className="w-5 h-5" />;
                                        ...
                                        return (
                                            <div
                                                key={workflow.id}
                                                className={cn(
                                                    "relative overflow-hidden p-6 border rounded-2xl transition-all duration-300",
                                                    isActive
