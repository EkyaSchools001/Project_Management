...
// ── Cluster 4 Rubric Definition ────────────────────────────────────────────────
const SUBDOMAINS = [
  {
    code: "1b", title: "Knowing and Valuing Students",
    params: [
      { id: "1b_1", name: "Checks for Student Understanding", desc: "Checking understanding.", lookFor: "Frequent, targeted checks." },
      { id: "1b_2", name: "Differentiated Planning", desc: "Lesson planned for diverse needs.", lookFor: "Scaffolding, extensions." }
    ]
  },
  {
    code: "1c", title: "Setting Instructional Outcomes",
    params: [
      { id: "1c_1", name: "Learning Outcomes / Standards", desc: "Clear outcomes aligned to standards.", lookFor: "Rigorous goals." },
      { id: "1c_2", name: "Communication of Outcomes", desc: "Outcomes clearly communicated.", lookFor: "Students know the goal." }
    ]
  },
  {
    code: "1d", title: "Demonstrating Knowledge of Resources",
    params: [
      { id: "1d_1", name: "Purposeful Use of Resources", desc: "Resources used meaningfully.", lookFor: "Enhances learning." }
    ]
  },
  {
    code: "3d", title: "Using Assessment in Instruction",
    params: [
      { id: "3d_1", name: "Monitoring Student Learning During the Class", desc: "Active monitoring.", lookFor: "Checking progress." },
      { id: "3d_2", name: "Feedback During Class", desc: "Providing actionable feedback.", lookFor: "Specific, timely." },
      { id: "3d_3", name: "Monitoring Through Post-Work", desc: "Reviewing homework or assignments.", lookFor: "Regular review." },
      { id: "3d_4", name: "Notebook Feedback", desc: "Feedback on notebook work.", lookFor: "Written comments." },
      { id: "3d_5", name: "Assessment Criteria / Rubrics", desc: "Clear grading criteria.", lookFor: "Rubrics provided." },
      { id: "3d_6", name: "Monitoring Alignment to Assessment", desc: "Ensuring tasks align with assessment.", lookFor: "Coherent tasks." }
    ]
  },
  {
    code: "3e", title: "Flexibility and Responsiveness to Student Needs",
    params: [
      { id: "3e_1", name: "Responsive Teaching", desc: "Adapting lesson based on needs.", lookFor: "In-the-moment adjustments." }
    ]
  }
];
...
// ── Main Page ──────────────────────────────────────────────────────────────────
const Cluster4QuickFeedbackPage: React.FC = () => {
  ...
  const buildPayload = (status: "DRAFT" | "SUBMITTED") => ({
    ...
    observerId: user?.id,
    date,
    domain: "Cluster 4 - Successful Learning",
    type: "quick-feedback",
    status,
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 pt-6">
          <div className="relative h-[200px] md:h-[240px] overflow-hidden rounded-[2.5rem] shadow-2xl mb-8 bg-[#EA104A]">
            ...
            <div className="absolute inset-0 flex flex-col justify-center pl-10 md:pl-16">
              ...
              <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter leading-[0.9] uppercase drop-shadow-2xl">Successful Learning</h1>
              <p className="text-white/80 font-medium text-sm mt-2">Cluster 4 · Quick Feedback</p>
            </div>
          </div>
        </div>
...
export default Cluster4QuickFeedbackPage;
