...
import { portfolioService, PortfolioSummary, TimelineEvent, PortfolioAchievement } from "@/services/portfolioService";
...
export function TeacherPortfolio() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-primary/20">
        <div>
      ...
      <Card className="border-0 shadow-sm overflow-hidden">
        <CardHeader className="bg-gray-50/50 border-b border-primary/20">
            ...
            {timeline.length === 0 ? (
              ...
              timeline.map((event, index) => (
                <div key={event.id} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                  ...
                  <div className="w-[calc(100%-4rem)] md:w-[calc(50%-3rem)] p-5 rounded-xl border border-primary/20 bg-white shadow-sm hover:shadow-md transition-shadow duration-300">
...
function SummaryCard({ title, value, icon, bgColor }: { title: string, value: string, icon: React.ReactNode, bgColor: string }) {
  return (
    <div className="bg-white p-6 rounded-2xl shadow-sm border border-primary/20 flex items-center gap-4 hover:shadow-md transition-shadow duration-300">
