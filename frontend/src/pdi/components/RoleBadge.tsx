...
export type Role = "teacher" | "leader" | "school_leader" | "admin" | "superadmin" | "management";
...
const roleConfig = {
  ...
  management: { label: "Management", icon: Building2, className: "bg-backgroundackgroundlue-600/10 text-blue-600 border-blue-600/20" },
};
