    ...
    return (
      <div className="flex items-center gap-4 p-4 bg-[#161B22] border border-white/5 rounded-2xl">
        <div className="w-12 h-12 bg-[#ef4444]/20 rounded-xl flex items-center justify-center">
          <Star size={24} className="text-[#ef4444]" />
        </div>
        <div className="flex-1">
          ...
          <div className="h-2 bg-white/10 rounded-full overflow-hidden">
            <div 
              className="h-full bg-gradient-to-r from-[#ef4444] to-[#7AFF00] rounded-full"
    ...
    <Card className="bg-[#161B22] border-white/5 p-6 rounded-2xl">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 bg-gradient-to-br from-[#ef4444] to-[#7AFF00] rounded-2xl flex items-center justify-center">
          ...
          <div>
            ...
            <p className="text-xs text-[#ef4444]">Level {currentLevel.level}</p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        <div className="h-4 bg-white/10 rounded-full overflow-hidden relative">
          <div 
            className="h-full bg-gradient-to-r from-[#ef4444] to-[#7AFF00] rounded-full transition-all duration-1000"
            style={{ width: `${progressPercent}%` }}
          />
        ...
        {nextLevel && (
          <div className="flex items-center justify-between pt-4 border-t border-white/5">
            ...
            <div className="px-3 py-1 bg-[#ef4444]/10 rounded-lg">
              <span className="text-xs font-bold text-[#ef4444]">Level {nextLevel.level}</span>
            </div>
          </div>
        )}
        ...
        {!nextLevel && (
          <div className="pt-4 border-t border-white/5">
            <p className="text-center text-sm text-[#ef4444] font-bold">
