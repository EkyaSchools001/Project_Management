...
export function MeetingScheduler({ onSubmit, onCancel, initialData, isLoading }: MeetingSchedulerProps) {
    ...
    const getProviderBadge = (type: MeetingProvider) => {
        const badges = {
            zoom: <Badge className="bg-red-500">Zoom</Badge>,
            google_meet: <Badge className="bg-red-500">Google Meet</Badge>,
            microsoft_teams: <Badge className="bg-red-500">MS Teams</Badge>,
