  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        {currentUserRank && (
          <div className="flex items-center gap-3 px-6 py-3 bg-[#ef4444]/10 border border-[#ef4444]/30 rounded-2xl">
            <Trophy size={24} className="text-[#ef4444]" />
            <div>
              <p className="text-xs text-[#ef4444] font-bold uppercase tracking-widest">Your Rank</p>
                ...
                return (
                  <div 
                    ...
                    className={`
                      ...
                      ${isCurrentUser ? 'bg-[#ef4444]/10 border border-[#ef4444]/30' : 'bg-white/5 hover:bg-white/10'}
                    `}
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={`font-bold text-lg truncate ${isCurrentUser ? 'text-[#ef4444]' : 'text-foreground'}`}>
                        {entry.userName}
                      </p>
