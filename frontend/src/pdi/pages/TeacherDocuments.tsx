...
import { documentService } from "@pdi/services/documentService";
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <Card>
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm text-zinc-900">Total Documents</p>
                    ...
                    <Card>
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm text-zinc-900">Pending Review</p>
                    ...
                    <Card>
                        <CardContent className="p-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm text-zinc-900">Requires Action</p>
                    ...
                    <CardContent className="p-4">
                        <div className="flex flex-col sm:flex-row gap-4">
                            <div className="flex-1 relative">
                                <Search className="absolute left-3 top-3 h-4 w-4 text-zinc-900" />
                                <Input
                                ...
                                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                                    <div className="flex items-start gap-4 flex-1">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-sm text-zinc-900 mb-2">{doc.description}</p>
                                            <div className="flex flex-wrap gap-4 text-xs text-zinc-900">
                ...
                {filteredDocuments.length === 0 && (
                    <Card>
                        <CardContent className="p-12 text-center">
                            <FileText className="w-12 h-12 text-zinc-900 mx-auto mb-4" />
                            <p className="text-zinc-900">No documents found</p>
                        </CardContent>
                    </Card>
                )}
            </div>
            ...
            <Dialog open={showViewDialog} onOpenChange={setShowViewDialog}>
                <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="space-y-4">
                        <div className="bg-muted/30 rounded-lg border overflow-hidden relative" style={{ minHeight: '400px', height: '60vh' }}>
                            {selectedDoc?.fileName === "External Link" ? (
                                <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center bg-muted/50">
                                    <ExternalLink className="w-16 h-16 text-zinc-900 mx-auto mb-4" />
                                    <p className="text-lg font-medium mb-2">External Link</p>
                                    <p className="text-sm text-zinc-900 mb-6">This document is hosted externally.</p>
                                    {selectedDoc?.fileUrl && (
                                        <Button
                                            onClick={async () => {
                                ...
                                <div className="absolute inset-0 flex items-center justify-center bg-muted/50 p-8 text-center">
                                    <div>
                                        <FileText className="w-16 h-16 text-zinc-900 mx-auto mb-4" />
                                        <p className="text-sm text-zinc-900 mb-2">No preview available</p>
                                        <p className="text-xs text-zinc-900">{selectedDoc?.fileName}</p>
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="flex items-center gap-2 text-sm text-zinc-900 border-t pt-4">
            ...
            <Dialog open={showSignDialog} onOpenChange={setShowSignDialog}>
                <DialogContent>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="text-xs text-zinc-900 bg-muted/50 p-3 rounded">
