...
const SUBDOMAINS = [
  {
    code: "2a", title: "Respectful & Affirming Environment",
    params: [
      { id: "2a_1", name: "Teacher–Student Interactions", desc: "", lookFor: "" },
      { id: "2a_2", name: "Student–Student Interactions", desc: "", lookFor: "" },
      { id: "2a_3", name: "Affirming Responses", desc: "", lookFor: "" },
    ],
  },
  {
    code: "2c", title: "Purposeful Learning Environment",
    params: [
      { id: "2c_1", name: "Visible Routines", desc: "", lookFor: "Warm up / cool down (PE/PA)\nLining up / dispersal\nResource handling" },
      { id: "2c_2", name: "Smooth Transitions", desc: "", lookFor: "" },
      { id: "2c_3", name: "Starting of Task", desc: "", lookFor: "" },
      { id: "2c_4", name: "Learning Time", desc: "", lookFor: "" },
    ],
  },
  {
    code: "2d", title: "Positive Behaviour",
    params: [
      { id: "2d_1", name: "On-Task Behaviour", desc: "", lookFor: "" },
      { id: "2d_2", name: "Response to Disruptions", desc: "", lookFor: "" },
      { id: "2d_3", name: "Clear Expectations", desc: "", lookFor: "" },
      { id: "2d_4", name: "Safety Procedures", desc: "", lookFor: "" },
      { id: "2d_5", name: "Self-Regulation", desc: "", lookFor: "" },
    ],
  },
  {
    code: "2e", title: "Physical Space",
    params: [
      { id: "2e_1", name: "Safe and Accessible Space", desc: "", lookFor: "" },
      { id: "2e_2", name: "Seating & Equipment Arrangement", desc: "", lookFor: "" },
      { id: "2e_3", name: "Boards and Displays", desc: "", lookFor: "" },
    ],
  },
];
...
const ROUTINES = [
  "Arrival", "Attendance", "Cleaning", "Material Passing",
  "Departure", "Grouping", "Lining Up", "Other"
];
...
// ── Main Page ──────────────────────────────────────────────────────────────────
const Cluster2SpecialistQFForm: React.FC = () => {
  ...
  const buildPayload = (status: "DRAFT" | "SUBMITTED") => ({
    ...
    observerId: user?.id,
    date,
    domain: "Cluster 2 - Classroom Management (Specialist)",
    type: "specialist-qf",
    status,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success("Cluster 2 Specialist Observation submitted!");
      navigate(-1);
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 pt-6">
          <div className="relative h-[200px] md:h-[240px] overflow-hidden rounded-[2.5rem] shadow-2xl mb-8 bg-[#EA104A]">
            ...
            <div className="absolute inset-0 flex flex-col justify-center pl-10 md:pl-16">
              ...
              <h1 className="text-4xl md:text-5xl font-black text-white tracking-tighter leading-[0.9] uppercase drop-shadow-2xl">Cluster 2 – Classroom Management (Specialist)</h1>
...
export default Cluster2SpecialistQFForm;
