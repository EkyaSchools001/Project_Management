            ...
            <div className="mx-auto max-w-7xl space-y-6">
              ...
              <div className="grid gap-6 lg:grid-cols-3">
                {[
                  ...
                  <div key={card.title} className="group cursor-pointer bg-white rounded-[2rem] p-8 shadow-sm border border-primary/20 hover:shadow-xl hover:border-primary/20 transition-all duration-300 flex flex-col justify-between">
                    <div className="flex justify-between items-start mb-6">
                      <h3 className="text-lg font-bold text-slate-900 tracking-wide">{card.title}</h3>
                      <div className="w-14 h-14 rounded-2xl border border-primary/20 shadow-sm flex items-center justify-center shrink-0 text-primary group-hover:bg-primary group-hover:text-white transition-colors bg-white">
