        ...
        return (
            <NavLink
                ...
                className={cn(
                    ...
                    isActive
                        ? "bg-sidebar-primary text-white shadow-sm hover:bg-sidebar-primary/90 cursor-default"
                        : "text-sidebar-foreground hover:bg-sidebar-accent"
                )}
            >
                <div className="flex items-center gap-3 min-w-0 flex-1">
                    <module.icon
                        className={cn(
                            ...
                            isActive ? "text-white" : "group-hover:scale-110 text-sidebar-foreground/70"
                        )}
                        ...
                        return (
                            <NavLink
                                ...
                                className={cn(
                                    ...
                                    isSubActive && "text-white font-bold bg-sidebar-primary shadow-sm hover:bg-sidebar-primary/90 cursor-default"
                                )}
                            >
