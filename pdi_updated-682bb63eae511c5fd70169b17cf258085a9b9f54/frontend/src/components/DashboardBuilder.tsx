...
export function DashboardBuilder({ initialRole }: DashboardBuilderProps) {
  ...
  const renderWidgetPreview = (widget: CanvasWidget) => {
      ...
      switch (widget.type) {
        ...
        case 'card': {
          ...
          return (
            ...
            }} className="p-8 bg-white border border-primary/20 shadow-sm hover:shadow-xl transition-all duration-300 group">
    ...
    if (widget.type === 'stats_premium') {
      ...
      return (
        <div style={{ ...widget.styles, height: '100%' }} className="bg-slate-50 border border-primary/20 p-6 flex flex-col justify-between group hover:bg-white hover:shadow-2xl transition-all duration-300 rounded-[24px]">
          <div className="flex justify-between items-start">
            ...
            <div className="w-14 h-14 rounded-2xl bg-white shadow-sm flex items-center justify-center text-red-500 border border-primary/20 group-hover:scale-110 group-hover:bg-red-50 group-hover:text-red-600 transition-all duration-500">
    ...
    if (widget.type === 'chat_mini') {
      return (
        <div className="absolute bottom-6 right-6 z-50 animate-bounce cursor-pointer">
          <div className="bg-white px-4 py-2 rounded-full shadow-2xl border border-primary/20 flex items-center gap-3">
    ...
    if (widget.type === 'sparkline') {
      return (
        <div style={{ ...widget.styles, height: '100%' }} className="bg-white p-6 flex items-center justify-between group hover:shadow-xl transition-all rounded-[24px] border border-primary/20">
          <div className="flex flex-col gap-1">
    ...
    if (widget.type === 'file_grid') {
      return (
        <div style={{ ...widget.styles, height: '100%' }} className="bg-slate-50 p-6 flex flex-col gap-4 rounded-[24px] border border-primary/20 overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-5 custom-scrollbar">
              {!selectedWidget ? (
                ...
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-200">
                  ...
                  {/* Content Settings */}
                  <div className="space-y-4 bg-slate-50 p-4 rounded-lg border border-primary/20">
