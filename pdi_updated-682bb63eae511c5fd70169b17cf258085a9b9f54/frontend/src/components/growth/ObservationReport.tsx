            ...
            <Card className="overflow-hidden border-none shadow-2xl bg-white rounded-[2rem]">
                ...
                <CardContent className="p-8 md:p-12">
                    <div className="flex flex-col md:flex-row justify-between gap-10">
                        <div className="flex-1 space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8 text-sm text-slate-600">
                                <div className="flex items-center gap-3">
                                    <div className="p-2 rounded-xl bg-slate-50 border border-primary/20">
                        ...
                        <div className="flex flex-col items-center justify-center bg-slate-50 rounded-[2.5rem] p-10 border border-primary/20 min-w-[240px] shadow-inner">
                            ...
                            {typeof overallRating === 'string' && overallRating !== "N/A" && (
                                <div className="mt-4 px-4 py-1.5 rounded-full bg-white border border-primary/20 shadow-sm">
                            ...
                            <div key={domain.domainId} className="p-8 space-y-6 hover:bg-slate-50/30 transition-colors">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    {domain.indicators?.map((indicator: any, i: number) => (
                                        <div key={i} className="flex flex-col justify-between p-4 rounded-2xl bg-white border border-primary/20 shadow-sm hover:shadow-md transition-all hover:border-[#B69D74]/30 group">
                                ...
                                {domain.evidence && (
                                    <div className="mt-4 p-5 rounded-2xl bg-slate-50 border border-primary/20 shadow-inner">
