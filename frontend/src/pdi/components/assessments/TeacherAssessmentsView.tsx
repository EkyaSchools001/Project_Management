...
import { assessmentService, Assessment, AssessmentAttempt } from "@pdi/services/assessmentService";
                ...
                <Card className="border-none shadow-md bg-white rounded-2xl overflow-hidden">
                    <CardContent className="pt-6">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-zinc-500 text-sm font-medium">Average Score</span>
                        </div>
                        <div className="text-3xl font-bold text-zinc-900">{Math.round(avgScore)}%</div>
                    </CardContent>
                </Card>
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {assignments.map((assignment: any) => {
                        ...
                        return (
                            <Card key={assignment.id} className="shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl overflow-hidden group">
