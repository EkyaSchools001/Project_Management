        ...
        <div className={containerClass}>
            {!embedded && (
                <div className="flex items-center justify-between p-4 border-b border-white/10 bg-[#161B22]">
                    <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-xl bg-[#BAFF00]/20 flex items-center justify-center">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                {messages.map((msg) => (
                    ...
                    >
                        {msg.role === 'assistant' && (
                            <div className="w-8 h-8 rounded-xl bg-[#BAFF00]/20 flex items-center justify-center flex-shrink-0">
                                <Bot className="w-4 h-4 text-[#BAFF00]" />
                            </div>
                        )}
                ...
                {loading && (
                    <div className="flex gap-3">
                        <div className="w-8 h-8 rounded-xl bg-[#BAFF00]/20 flex items-center justify-center">
                            <Bot className="w-4 h-4 text-[#BAFF00]" />
                        </div>
            ...
            <div className="p-4 border-t border-white/10">
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className="p-3 bg-[#BAFF00] text-black rounded-xl hover:bg-[#BAFF00]/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    >
...
export function FloatingChatbotButton({ onClick }) {
    return (
        <button
            onClick={onClick}
            className="fixed bottom-6 right-6 w-14 h-14 bg-[#BAFF00] rounded-full shadow-lg hover:scale-110 transition-transform flex items-center justify-center z-40"
        >
